...
import static com.javabom.toby.chapter1.pattern.추상_팩토리_패턴.PaymentSystemFactoryMaker.JAVABOM;
...
class PaySystemFactoryTest {
    ...
    public void abstractFactory() {
        PaySystemFactory paySystemFactory = JAVABOM.getPaySystemFactory();
