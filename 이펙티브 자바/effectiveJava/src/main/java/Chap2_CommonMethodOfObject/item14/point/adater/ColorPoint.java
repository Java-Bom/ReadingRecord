package Chap2_CommonMethodOfObject.item14.point.adater;

import Chap2_CommonMethodOfObject.item14.point.view.Point;
...
class ColorPoint implements Comparable<ColorPoint> {
    ...
    public ColorPoint(Chap2_CommonMethodOfObject.item14.point.view.Point point, int color) {
        this.point = point;
        this.color = color;
    }
